"""Load config and extract tasks from email text using the agent runner."""
...
def _extract_tasks_tool(*, text: str, model_client: ModelClient) -> list[ExtractedTask]:
    """Tool handler registered in the tool registry for task extraction."""
...
def Fetch_Tasks(text: str) -> list[ExtractedTask]:
    """Given email text, return a list of tasks the recipient needs to perform."""
